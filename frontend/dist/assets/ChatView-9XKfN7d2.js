import{d as y,c as l,a as s,F as v,r as _,w as C,v as A,k as I,h as u,l as M,f as c,t as h,n as f,j as x,_ as T}from"./index-C4OHA2y7.js";const w={class:"page chat-view"},E={class:"quick-questions fade-in fade-in-2"},V=["onClick"],B={class:"msg-avatar"},D={key:0,class:"ai-label"},H=["innerHTML"],L={class:"chat-input-bar"},R=["disabled"],S=y({__name:"ChatView",setup($){const o=u(),n=u(""),m=["大盘今天怎么样？","推荐几只股票","看看我的持仓","茅台还能买吗"],r=u([{role:"ai",content:`您好！我是StockMind AI，您的智能炒股助手。
